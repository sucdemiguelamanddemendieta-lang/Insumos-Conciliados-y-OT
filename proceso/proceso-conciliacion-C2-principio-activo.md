...
**En suspenso — el contador se reinició el 04/09.** El 02/09 glifosato, cletodim y 2,4-D habían cumplido la condición (dos corridas consecutivas sin documentación que los afecte) y el escalamiento quedó armado en `pedidos/2026-09-02_escalamiento_mercedes_2.docx`. Desde entonces llegó documentación que los afecta directamente: los nueve reescaneos con el consumo real, los remitos 11629 y 11682, y el export de costeo al 03/09 con cuatro remitos nuevos de esos mismos tres productos. Por la salvedad de 2.bis el contador vuelve a cero.

**El motivo de fondo sigue vigente:** Panzer Gold −315,62 L, cletodim −127,82 L y Herbifen −108,50 L en las OT hasta la 754, con el consumo real ya leído y todas las OT con su remito citado.

**Qué decide el próximo paso.** La pregunta concreta que quedó abierta es si los remitos 12205 (20/08) y 12343 (02/09) son entrega física de esas fechas o regularizan producto retirado antes. Traen 1.480 L de Panzer Gold y 620 L de Herbifen — más que suficiente para cubrir el faltante. Si regularizan, el punto se cierra sin escalamiento. Si son entrega corriente, el faltante queda sin explicación y se eleva.

**Se eleva** si la respuesta no cierra el punto, o si pasan dos corridas sin respuesta. La dirección de Mercedes sigue sin confirmar.
